...
import com.luoningqi.gmall.realtime.common.bean.UserRegisterBean;
...
public class DwsUserUserRegisterWindow extends BaseApp {
    ...
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> stream) {
        ...
        //4.添加水位线
        SingleOutputStreamOperator<UserRegisterBean> withWaterMarkStream = beanStream.assignTimestampsAndWatermarks(
                WatermarkStrategy
        ...
        //5.分组开窗聚合
        SingleOutputStreamOperator<UserRegisterBean> reduceStream = withWaterMarkStream
