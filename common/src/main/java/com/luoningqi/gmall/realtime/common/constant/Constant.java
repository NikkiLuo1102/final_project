package com.luoningqi.gmall.realtime.common.constant;
...
public class Constant {
    ...
    public static final String MYSQL_PASSWORD = "Windfall233!";
    ...
    public static final String DORIS_PASSWORD = "Windfall233";
